...
<head>
  ...
  <meta name="description" content="Find your lost items.">
  ...
  <meta property="og:title" content="Lost Items — WVSU Re:Claim">
  <meta property="og:description" content="Find your lost items.">
  <meta property="og:url" content="https://reclaim.wvsu-usc.org/lost">
  ...
  <meta name="twitter:title" content="Lost Items - WVSU Re:Claim">
  <meta name="twitter:description" content="Find your lost items.">
  <meta name="twitter:image" content="https://reclaim.wvsu-usc.org/assets/Re_Claim Logo Icon.svg">
  <link rel="canonical" href="https://reclaim.wvsu-usc.org/lost">
  ...
  <title>Lost Items — WVSU Re:Claim</title>
...
<main class="mx-auto max-w-[1327px] px-4 py-8 sm:px-6 sm:py-10">
  <hgroup class="mb-8 space-y-2 text-center">
        <h1 class="text-center text-display-md font-bold text-black">Lost Items</h1>
  </hgroup>
  ...
  <nav aria-label="Listing type" class="mb-10 flex justify-center">
    <ul class="flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-md font-semibold sm:gap-8">
      <li>
        <a href="/lost" class="border-b-2 border-primary-500 pb-1 text-primary-700">
          Lost Items
        </a>
      </li>
      <li>
