    ...
    <main class="grid grid-cols-1 lg:grid-cols-2 gap-10 w-full max-w-7xl mx-auto h-full items-center">
        ...
        <section class="w-full max-w-105 mx-auto lg:mx-0 lg:ml-auto">
            ...
            <header class="text-center mb-8">
                ...
                <h1 class="text-display-md text-primary font-semibold">Set New Password</h1>
            ...
            <form method="POST" action="/reset-password" class="space-y-5">
                ...
                <!-- Confirm Password -->
                <div>
                    <label class="text-sm font-semibold text-primary" for="confirm-password">Confirm Password</label>
                    <div class="relative">
                        <input 
                            id="confirm-password"
                            type="password" 
