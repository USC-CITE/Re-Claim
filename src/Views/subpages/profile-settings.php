...
<body>
    ...
    <main class="max-w-5xl mx-auto mt-16 px-6">
        ...
        <nav class="relative w-full border-b border-gray-400 pb-4 mb-6">
            <div class="flex justify-center sm:justify-start">
                <div id="tabScrollSettings"
                    ...
                    <button type="button"
                        class="tab-btn shrink-0 py-2 text-md font-semibold text-gray-600 border-b-2 border-transparent hover:border-gray-300 transition"
                ...
                <div class="flex flex-col items-left gap-6 sm:flex-row sm:items-center">
                    <div class="w-24 h-24 rounded-full overflow-hidden ring-2 ring-gray-200">
                        <img id="avatarPreview"
                            src="<?= htmlspecialchars($_SESSION['avatar'] ?? '/avatars/default.png') ?>"
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            <!-- Delete Button -->
                            <button type="button" id="deleteAvatarBtn" <?= (!isset($_SESSION['avatar']) || $_SESSION['avatar'] === '/avatars/default.png') ? 'disabled' : '' ?>
                ...
                <section>
                    ...
                    <div class="space-y-4">
                        <div class="flex flex-col">
                            ...
                            <input
                                class="w-full mt-1 border rounded-lg px-3 py-2  <?= !empty($errors['first_name']) ? 'border-red-500 border-2' : 'border-gray-300' ?> text-sm"
                                name="first_name" value="<?= htmlspecialchars($_SESSION['first_name'] ?? '') ?>">
                        ...
                        <div class="flex flex-col">
                            ...
                            <input name="last_name"
                                class="w-full mt-1 border rounded-lg px-3 py-2  <?= !empty($errors['last_name']) ? 'border-red-500 border-2' : 'border-gray-300' ?>text-sm"
                ...
                <section>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="flex flex-col">
                            ...
                            <button type="button" id="addLinkBtn" onclick="addLink()"
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex flex-col">
                        ...
                        <input name="current_password" type="password"
                            class="w-full mt-1 border rounded-lg px-3 py-2 <?= !empty($errors['current_password']) ? 'border-red-500 border-2' : 'border-gray-300' ?> text-sm"
                    ...
                    <div class="flex flex-col">
                        ...
                        <input name="new_password" type="password"
                            class="w-full mt-1 border rounded-lg px-3 py-2 <?= !empty($errors['new_password']) ? 'border-red-500 border-2' : 'border-gray-300' ?> text-sm"
                    ...
                    <div class="flex flex-col">
                        ...
                        <input name="confirm_password" type="password"
                            class="w-full mt-1 border rounded-lg px-3 py-2 <?= !empty($errors['confirm_password']) ? 'border-red-500 border-2' : 'border-gray-300' ?> text-sm"
                            required>
                        <p class="text-red-500 text-sm">
        ...
        <section class="tab-content max-w-2xl mx-auto" id="delete-account">
            <form action="/profile/delete" method="post" class="space-y-2">
                <?php \App\Core\Router::setCsrf(); ?>
                <p>Deleting your account will permanently remove your Re:Claim profile and all associated content. This
                    action will be irreversible. </p>
                <div class="flex justify-start">
                    <button type="submit" onclick="return confirm('Are you sure? This action cannot be undone.')"
    ...
    <div id="otpModal"
        class="fixed p-2 inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 <?= $showOtpModal ? '' : 'hidden' ?>">
            ...
            <div class="flex flex-col items-center text-center space-y-3 mb-6">
                ...
                <div class="w-20 h-20 rounded-full bg-[#055BA8] flex items-center justify-center">
                    <svg width="40" height="39" viewBox="0 0 40 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M1.5 33.4082V15.1392C1.5 13.7711 2.18697 12.4936 3.33068 11.7347L17.7196 2.18721C19.1005 1.27093 20.8995 1.27093 22.2804 2.18721L36.6693 11.7347C37.813 12.4936 38.5 13.7711 38.5 15.1392V33.4082M1.5 33.4082C1.5 35.6681 3.34061 37.5 5.61111 37.5H34.3889C36.6594 37.5 38.5 35.6681 38.5 33.4082M1.5 33.4082L15.375 24.2018M38.5 33.4082L24.625 24.2018M1.5 14.9953L15.375 24.2018M38.5 14.9953L24.625 24.2018M24.625 24.2018L22.2804 25.7574C20.8995 26.6737 19.1005 26.6737 17.7196 25.7574L15.375 24.2018"
