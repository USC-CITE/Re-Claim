<?php
    $currentHost = htmlspecialchars($_SERVER['HTTP_HOST']);
?>
...
<head>
    ...
    <meta name="description" content="Re:Claim is a centralized lost and found tracking system for West Visayas State University - Main Campus.">
    ...
    <meta property="og:title" content="Re:Claim — WVSU's Lost & Found Platform">
    <meta property="og:description" content="A centralized lost and found tracking system for West Visayas State University - Main Campus.">
    <meta property="og:url" content="https://reclaim.wvsu-usc.org">
    ...
    <meta name="twitter:title" content="Re:Claim — WVSU's Lost & Found Platform">
    <meta name="twitter:description" content="A centralized lost and found tracking system for West Visayas State University - Main Campus.">
    <meta name="twitter:image" content="assets/Re_Claim Logo Icon.svg">
    <link rel="canonical" href="<? echo htmlspecialchars($_SERVER['HTTP_HOST']); ?>">
    ...
    <title>Re:Claim — WVSU’s Lost & Found Platform</title>
