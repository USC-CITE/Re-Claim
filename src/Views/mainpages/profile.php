                    ...
                    <div class="md:w-auto md:mt-0">
                        ...
                        <ul class="space-y-2 mt-2">
                            ...
                            <li class="flex items-center gap-2">
                                ...
                                ?>
                                <a class="text-sm" href="<?= htmlspecialchars($social) ?>"
                                target="_blank" rel="noopener noreferrer" class="text-sm text-blue-600 hover:underline break-all"><?= htmlspecialchars($_SESSION['social_link']) ?></a>
                            </li>
                        </ul>
                    </div>
